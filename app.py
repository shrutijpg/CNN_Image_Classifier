...
if st.session_state.predict_clicked:
    if upload_file is None:
        st.warning("⚠ Please upload or select an image before running prediction.")
        st.session_state.predict_clicked = False
    else:
        try:
...
st.markdown("---")
st.markdown("[📂 View Source Code on GitHub](https://github.com/shrutijpg/CNN_Image_Classifier)")

# Contact info or credit
st.sidebar.markdown("---")
st.sidebar.markdown("👨‍💻 Built by Shruti Bhandarkar**")
st.sidebar.markdown("[🐙 GitHub](https://github.com/shrutijpg) | [🔗 LinkedIn](https://www.linkedin.com/in/shruti-b-51a3a9263/)")
